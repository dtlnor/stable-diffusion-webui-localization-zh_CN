...
- [ ] [动态提示词](https://github.com/adieyal/sd-dynamic-prompts)  
...
- [ ] [训练图挑选器](https://github.com/Maurdekye/training-picker)  
- [ ] [非文本（代码化）提示词](https://github.com/ThereforeGames/unprompted)  
...
- [ ] [检测细致化](https://github.com/dustysys/ddetailer.git)  
...
- [ ] [自动 TLS-HTTPS](https://github.com/papuSpartan/stable-diffusion-webui-auto-tls-https.git)  
- [ ] [梦作家](https://github.com/7eu7d7/DreamArtist-sd-webui-extension.git)  
- [ ] [WD 1.4 词元化](https://github.com/toriato/stable-diffusion-webui-wd14-tagger.git)  
